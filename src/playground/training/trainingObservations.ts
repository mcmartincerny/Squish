...
export function buildTrainingObservation(
  ...
  const leftLeg = world.getConstraintSnapshot(controller.rig.leftLegConstraintId);
  const rightLeg = world.getConstraintSnapshot(controller.rig.rightLegConstraintId);
